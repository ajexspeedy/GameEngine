...
dae::PlayerLivesDisplay::PlayerLivesDisplay(GameObject* pParent, const std::shared_ptr<Font>& font, int lives, float x, float y) :
	Component{ pParent },
	...
	m_UpdateLives(false)
{
	...
	m_pTextComponent = std::make_unique<TextComponent>(pParent, text, font);

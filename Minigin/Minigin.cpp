...
void dae::Minigin::LoadGame() const
{
	...
	auto fps_counter = new GameObject(new FPSComponent("FPS: 0", sansFont),"FPS_Counter");
	...
	
	{
		// Player 1 
		int lives = 3;
		auto qbert = new GameObject(new RenderComponent("Qbert.png"), "Qbert");
		auto* playerComponent = new PlayerComponent(1, lives);
		auto* healthDisplay = new PlayerLivesDisplay(sansFont,lives,180.f);
		auto* scoreDisplay = new PlayerScoreDisplay(sansFont,350.f,0);
		...
		auto qbert2 = new GameObject(new RenderComponent("Qbert.png",50.f), "Qbert2");
		auto* playerComponent2 = new PlayerComponent(1, lives);
		auto* healthDisplay2 = new PlayerLivesDisplay(sansFont, lives, 180.f,20.f);
		auto* scoreDisplay2 = new PlayerScoreDisplay(sansFont, 350.f,20.f);
